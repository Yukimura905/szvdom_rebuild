...
function get_text($hh_blocks){
	$arText = array();
	$ath = mysql_query("select * from mp_themes_pages where hh_blocks = ".$hh_blocks);
...
function addImg($arImages, $el_id){
	...
	//$arFile = array(
	//0 => array("VALUE" => CFile::MakeFileArray($src),"DESCRIPTION"=>""),
	//1 => array("VALUE" => CFile::MakeFileArray($src),"DESCRIPTION"=>"")
	//);
