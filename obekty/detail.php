...
?><?$APPLICATION->IncludeComponent("bitrix:catalog.element", "jk_ver6", Array(
	"ACTION_VARIABLE" => "action",	// Название переменной, в которой передается действие
		"ADD_DETAIL_TO_SLIDER" => "N",	// Добавлять детальную картинку в слайдер
		"ADD_ELEMENT_CHAIN" => "N",	// Включать название элемента в цепочку навигации
		"ADD_PICT_PROP" => "MORE_IMG",	// Дополнительная картинка основного товара
		...
		"PROPERTY_CODE" => array(	// Свойства
			...
			9 => "APART_TYPES",
			10 => "APART_COUNT",
			11 => "APART_COUNT_TOTAL",
			12 => "APART_PRICE_DIAPASON",
			13 => "APART_PRICE_MIN",
			14 => "APART_PRICE_MAX",
			15 => "APART_AREA_DIAPASON",
			16 => "APART_AREA_MIN",
			17 => "APART_AREA_MAX",
			18 => "APART_OTDELKA",
			19 => "HF_BUILD_TYPE",
